...
<div {{ $attributes->class('filament-peek-preview-component-wrapper') }}>
    <div
        class="filament-peek-preview-component"
        ...
        x-on:refresh-preview-component.window="onRefreshPreviewComponent"
        wire:ignore
    >
