...
|------|----------|-----|--------|
| [4.x](https://github.com/pboivin/filament-peek/tree/4.x) | TBD | ^5.0 | ^8.2 |
...
- [Configuration](https://github.com/pboivin/filament-peek/blob/3.x/docs/configuration.md)
    - [Publishing the Config File](https://github.com/pboivin/filament-peek/blob/3.x/docs/configuration.md#publishing-the-config-file)
    - [Available Options](https://github.com/pboivin/filament-peek/blob/3.x/docs/configuration.md#available-options)
    - [Integrating With a Custom Theme](https://github.com/pboivin/filament-peek/blob/3.x/docs/configuration.md#integrating-with-a-custom-theme)
- [Page Previews](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md)
    - [Overview](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md#overview)
    - [Using the Preview Modal on Edit pages](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md#using-the-preview-modal-on-edit-pages)
    - [Using the Preview Modal on List pages](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md#using-the-preview-modal-on-list-pages)
    - [Using a Preview URL](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md#using-a-preview-url)
    - [Embedding a Preview Action into the Form](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md#embedding-a-preview-action-into-the-form)
    - [Preview Pointer Events](https://github.com/pboivin/filament-peek/blob/3.x/docs/page-previews.md#preview-pointer-events)
