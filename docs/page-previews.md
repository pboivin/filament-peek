...
The same steps can be used to add preview on other types of pages in your Panel: `View`, `Create`, `List` and even custom pages.


#### Note for Laravel 13 +

You may need to add your model to the `serializable_classes` array in `config/cache.php` for previews to function correctly:
